...
public:
	...
	addr_t detectorSystem0_start_addr = 0x73000000;
 	addr_t detectorSystem0_size = 0x01000016;
 	addr_t detectorSystem0_end_addr = detectorSystem0_start_addr + detectorSystem0_size - 1;
	addr_t detectorSystem1_start_addr = 0x75000000;
 	addr_t detectorSystem1_size = 0x01000016;
 	addr_t detectorSystem1_end_addr = detectorSystem1_start_addr + detectorSystem1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > detectorSystem1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	DetectorSystem detector_system0("detector_system0");
	DetectorSystem detector_system1("detector_system1");
	...
	core0.init(&core0_mem_if, &core0_mem_if, &clint,  loader.get_entrypoint(), opt.mem_end_addr - 3); 
	...
	bus.ports[12] = new PortMapping(opt.detectorSystem0_start_addr,opt.detectorSystem0_end_addr);
	bus.ports[13] = new PortMapping(opt.detectorSystem1_start_addr,opt.detectorSystem1_end_addr);
	...
	bus.isocks[12].bind(detector_system0.tsock);
	bus.isocks[13].bind(detector_system1.tsock);
